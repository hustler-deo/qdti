...
var annotations2 = [];
export default function SettingXandYCoordinatesinaContourPlotBlock(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  useEffect(() => {
    //  console.log('DPDP', props.box, props.x, props.y)
    setNode1(true);
  }, [box1]);
    ...
    <>
      ...
      >
        <h3 style={{ borderBottom: "1px solid #FFF", padding: 10 }}>
          Setting the X and Y Coordinates in a Contour Plot
        </h3>
        {props.data ? null : (
