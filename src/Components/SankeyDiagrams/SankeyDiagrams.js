...
var annotations2 = [];
export default function SankeyDiagrams(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  //   xaxisNumeric =
  //     props.x &&
  //     props.x.filter(function (i) {
  //       //    console.log('seeI', i)
  //       return i.match(/^[0-9]+$/) != null
  //     }).length > 0

  //   yaxisNumeric =
  //     props.y &&
  //     props.y.filter(function (i) {
  //       //    console.log('seeI', i)
  //       return i.match(/^[0-9]+$/) != null
  //     }).length > 0
  ...
  return props.block ? (
    <>
      ...
      >
        <h3 style={{ borderBottom: "1px solid #FFF", padding: 10 }}>Sankey</h3>
        {props.data ? null : (
          ...
          {props.IsDataNumeric === true ? (
            ...
            >
              <div style={{ marginTop: 90 }}>
                This Graph requires x and y axis data containing decimal numbers
                only
              </div>
            </div>
          )}
