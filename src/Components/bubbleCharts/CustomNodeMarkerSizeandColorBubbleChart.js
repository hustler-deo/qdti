...
var annotations2 = []
export default function CustomNodeMarkerSizeandColorBubbleChart (props) {
  const removeStyle = {
    position: 'absolute',
    top: 20,
    right: 20,
    ...
    <>
      ...
      >
        <h3 style={{ borderBottom: '1px solid #FFF', padding: 10 }}>
          Marker Size and Color on BubbleChart
        </h3>
        {props.data ? null : (
        ...
        <div style={{ marginTop: -10 }}>
          <div style={{ overflow: 'hidden', height: 300 }}>
            <Plot
              ...
              layout={{ width: 300, height: 290, showlegend: false }}
              config={{
                displaylogo: false,
                displayModeBar: true
              }}
