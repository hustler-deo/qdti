...
var annotations2 = [];
export default function SunburstWithRepetedLabels(props) {
  ...
  return props.block ? (
    ...
    <Plot
      ...
      layout={{
        margin: { l: props.main === true ? 350 : 30, r: 0, b: 0, t: 0 },
        width: props.main === true ? 700 : 300,
        height: props.main === true ? 500 : 250,
