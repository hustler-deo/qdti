...
var annotations2 = [];
export default function CustomNodeBasicPointCloud(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  var xy = new Float32Array(props.x);
            ...
            {props.IsDataNumeric === true ? (
              ...
              >
                <div style={{ marginTop: 90 }}>
                  This Graph requires x data containing numbers only
                </div>
              </div>
            )}
          </div>
    ...
    <div>
      {props.IsDataNumeric === true ? (
        ...
        <div>
          ...
          >
            This Graph requires x axis data containing numbers only
          </div>
        </div>
      )}
    </div>
