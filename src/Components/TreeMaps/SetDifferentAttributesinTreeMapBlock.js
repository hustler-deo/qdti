...
var annotations2 = [];
export default function SetDifferentAttributesinTreeMapBlock(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
    ...
    <Plot
      ...
      layout={
        props.main === true
          ...
          : { width: 500, height: 350, margin: { l: 0 } }
      }
    />
  );
}
