...
var annotations2 = [];
export default function BasicHeatmapBlock(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  useEffect(() => {
    ...
    //  console.log('box->', props.dashboard, props.box)
  }, []);
  //console.log('heatMap-', props.IsDataNumeric === true, props.IsDataNumeric)
  useEffect(() => {
