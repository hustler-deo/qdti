...
var annotations2 = []
export default function CustomNodeTimeseriesBlock (props) {
  const removeStyle = {
    position: 'absolute',
    top: 20,
    right: 20,
  ...
  return (
    <>
      ...
      >
        ...
        {/* <p>Data is currently clustered from lower to higher with Max Limit and Min limit from data source</p> */}
        <div style={{ marginTop: 32 }}>
          ...
          <Plot
            data={[
              ...
              { type: 'bar', x: props.data, y: props.data }
            ]}
            layout={{ width: 300, height: 200, title: 'TimeSeries' }}
          />
        </div>
      </div>
      <Handle
