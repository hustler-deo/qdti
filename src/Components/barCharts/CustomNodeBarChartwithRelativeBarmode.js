...
var annotations2 = [];
export default function CustomNodeBarChartwithRelativeBarmode(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
    ...
    <>
      ...
      >
        <h3 style={{ borderBottom: "1px solid #FFF", padding: 10 }}>
          BarChart with Relative Barmode
        </h3>
        {props.data ? null : (
          ...
          <div style={{ overflow: "hidden", height: 300 }}>
            <Plot
              ...
              data={[
                ...
                { type: "bar", x: props.x, y: props.y, name: "Color2" },
              ]}
              layout={{
                width: 300,
                height: 290,
