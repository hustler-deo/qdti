...
var annotations2 = [];
export default function CustomNodeBarChartwithDirectLabels(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
        ...
        <div style={{ marginTop: -10 }}>
          <div style={{ overflow: "hidden", height: 300 }}>
            <Plot
              ...
              layout={{ width: 300, height: 290, barmode: "stack" }}
              config={{
                displaylogo: false,
                displayModeBar: true,
              }}
