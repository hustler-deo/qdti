...
var annotations2 = [];
export default function BindingtoZoomEventsBlock(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  return props.block ? (
      ...
      >
        ...
        <div style={{ overflow: "hidden", height: 300 }}>
          <div style={{ marginTop: -65 }}>
            <div id="graph" style={{ marginTop: -50, height: 240 }}>
              <Plot
                ...
                layout={{ width: 300, height: 290, showSendToCloud: true }}
                config={{
                  displaylogo: false,
                }}
              />
    ...
    <div
      style={{
        overflow: "hidden",
        height: props.main === true ? 600 : 280,
        marginTop: props.main === true ? 10 : 70,
      }}
    >
      <Plot
        onClick={annotate}
        ...
        layout={{
          ...
          height: props.main === true ? 535 : 280,
