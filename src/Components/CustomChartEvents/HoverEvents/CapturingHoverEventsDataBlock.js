...
var annotations2 = [];
var hoverInfo;
export default function CapturingHoverEventsDataBlock(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  useEffect(() => {
    hoverInfo = document.getElementById("hoverinfo1");
  }, []);
  ...
  const onUnHover1 = (data) => {
    if (hoverInfo.innerHTML) hoverInfo.innerHTML = "";
  };
  var myArray, unique;
  var t1 = [];
  var obj = {};
  ...
  return props.block ? (
      ...
      >
        ...
        <div style={{ marginTop: -10 }}>
          <div style={{ overflow: "hidden", height: 300 }}>
            ...
            />
            <div id="hoverinfo1" style={{ marginTop: 25 }}></div>
          </div>
        </div>
      </div>
    ...
    <>
      ...
      />
      <div id="hoverinfo1" style={{ marginTop: 5, color: "black" }}></div>
    </>
  );
}
