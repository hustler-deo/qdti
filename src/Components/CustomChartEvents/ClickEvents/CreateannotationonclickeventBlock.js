...
var annotations2 = [],
  annotations3 = []
export default function CreateannotationonclickeventBlock (props) {
  const removeStyle = {
    position: 'absolute',
    top: 20,
    right: 20,
  ...
  var annotation, annotate_text
  var annotations3 = []
  const createAnotations = data => {
    var pts = ''
    for (var i = 0; i < data.points.length; i++) {
      annotate_text = 'x = ' + data.points[i].x + 'y = ' + data.points[i].y
      ...
      annotations3.push(annotation)
      //  Plotly.relayout('graph22', { annotations: annotations })
    }
  }
  ...
  return props.block ? (
    ...
    <Plot
      ...
      layout={{
        ...
        margin: props.main === true ? { l: 200 } : null,
