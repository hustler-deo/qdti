...
var annotations2 = [];
export default function DisablingZoomEventsforXAxisBlock(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  function makePlotly(x, y, standard_deviation) {
    var plotDiv = document.getElementById("graph11");
    var traces1 = [
      {
        x: props.x,
        y: props.y,
    ...
    Plotly.newPlot("graph11", traces1, layout, config);
  }
  var myArray, unique;
  var t1 = [];
  var obj = {};
      ...
      >
        ...
        <div style={{ overflow: "hidden", height: 300 }}>
          <div style={{ marginTop: -65 }}>
            <div id="graph11" style={{ marginTop: -50, height: 240 }}>
              {/* <Plot
              style={{ marginTop: -75 }}
              data={[
                {
...
displayModeBar: true
    ...
    <div
      ...
      style={
        props.main === true
          ? { marginTop: 80, marginLeft: -60, height: 550, width: 900 }
          : { marginTop: -50, height: 240 }
      }
    >
      {/* <Plot
    style={{ marginTop: -75 }}
