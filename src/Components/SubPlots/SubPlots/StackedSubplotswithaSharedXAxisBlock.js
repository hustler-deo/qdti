...
var annotations2 = [];
export default function StackedSubplotswithaSharedXAxisBlock(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  return props.block ? (
    ...
    <Plot
      ...
      layout={{
        width: props.main === true ? 900 : 380,
        height: props.main === true ? 570 : 290,
        margin: props.main === true ? { l: 280 } : null,
        xaxis: {
          title: props.xName,
        },
        yaxis: {
