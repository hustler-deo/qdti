...
var annotations2 = [];
export default function SimpleSubplotBlock(props) {
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
  ...
  return props.block ? (
    ...
    <Plot
      ...
      layout={{
        width: props.main === true ? 900 : 500,
        height: props.main === true ? 570 : 310,
        margin: props.main === true ? { l: 300 } : { l: 300 },
        xaxis: {
          title: props.xName,
        },
        yaxis: {
