...
var annotations2 = []
export default function MixedSubPlotsBlock (props) {
  const removeStyle = {
    position: 'absolute',
    top: 20,
    right: 20,
  ...
  return props.block ? (
          ...
          <div style={{ overflow: 'hidden', height: 300 }}>
            <Plot
              ...
              layout={{
                ...
                zaxis: { title: 'Elev', showgrid: true, gridcolor: 'white' },
    ...
    <Plot
      ...
      layout={{
        width: props.main === true ? 1000 : 350,
        height: props.main === true ? 1400 : 350,
        xaxis: {
          title: 'Status',
          showticklabels: false,
          showgrid: true,
