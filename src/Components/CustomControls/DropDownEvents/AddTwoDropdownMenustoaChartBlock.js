...
var annotations2 = []
export default function AddTwoDropdownMenustoaChartBlock (props) {
  const removeStyle = {
    position: 'absolute',
    top: 20,
    right: 20,
  ...
  const plotGraph = () => {
    Plotly.newPlot(
      ...
      {
        layout: {
          height: props.main === true ? 900 : 310,
    ...
    <>
      ...
      >
        <h3 style={{ borderBottom: '1px solid #FFF', padding: 10 }}>
          Add Two Dropdown Menus to a Chart
        </h3>
        {props.data ? null : (
        ...
        <div style={{ overflow: 'hidden', height: 300 }}>
          <div style={{ marginTop: -65 }}>
            <div id='graph17' style={{ marginTop: -50, height: 240 }}>
              {/* <Plot
              style={{ marginTop: -75 }}
              data={[
                {
...
displayModeBar: true
    ...
    <div
      ...
      style={
        props.main === true
          ? { marginTop: 80, height: 550, width: 750, marginLeft: 90 }
          : { marginTop: -50, height: 350 }
      }
    ></div>
  )
}
