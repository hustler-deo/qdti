...
var annotations2 = [];
export default function WorldChoroplethMap(props) {
  // console.log('Branch values', props.data, props.x, props.y, props.z)
  const removeStyle = {
    position: "absolute",
    top: 20,
    right: 20,
      ...
      <Plot
        style={
          props.main === true
            ...
            : { marginTop: props.primary ? -105 : -65, marginLeft: -150 }
        }
        data={props.primary ? data2 : data}
        layout={
          props.main === true
            ? {
            ...
            : {
                width: props.primary ? 540 : 540,
                height: props.primary ? 500 : 350,
                margin: { l: 10, b: 30, t: 10, r: 10 },
                geo: {
                  projection: {
                    type: "robinson",
                  },
