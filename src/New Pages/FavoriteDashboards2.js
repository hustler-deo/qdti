...
const FavoriteDashboards2 = () => {
  ...
  const handleSortDashboards = () => {
    ...
    favouriteDashboards?.sort(function (a, b) {
    ...
    setFavouriteDashboards(favouriteDashboards);
    setSortAsc(!sortAsc);
  };
  return (
    <>
      {authContext.isLoggedIn ? (
        ...
        >
          ...
          ) : dashboards === undefined && favouriteDashboards === undefined ? (
            <Box
              sx={{
                marginTop: "-4%",
                display: "flex",
...
export default FavoriteDashboards2;
