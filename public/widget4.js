var retrievedObject = localStorage.getItem("W4ChartData");
var retrievedObject2 = localStorage.getItem("W4Operations");
...
function getGraphImage() {
  ...
  const graphDiv = document.getElementById("myPlot4");
