var retrievedObject = localStorage.getItem('GChartData')
var retrievedObject2 = localStorage.getItem('GChartData2')
...
if (localStorage.getItem('WIDGET') == 1) Plotly.newPlot('myPlot1', data, layout)
if (localStorage.getItem('WIDGET') == 2) Plotly.newPlot('myPlot2', data, layout)
