var retrievedObject = localStorage.getItem("W5ChartData");
var retrievedObject2 = localStorage.getItem("W5Operations");
...
Plotly.newPlot("myPlot5", data, layout, config);
...
function getGraphImage() {
  ...
  const graphDiv = document.getElementById("myPlot5");
