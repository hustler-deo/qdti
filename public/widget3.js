var retrievedObject = localStorage.getItem("W3ChartData");
var retrievedObject2 = localStorage.getItem("W3Operations");
...
function getGraphImage() {
  ...
  const graphDiv = document.getElementById("myPlot3");
